# Description: This file contains the prompt templates for the tasks in the project.
...
Warning: if there is no data for any of the fields, leave it blank.
        ...
        "Career Trajectory: " and separate multiple entries with a -> .
...
template_format_instructions = template + """ \n{format_instructions}\n """

print(template_format_instructions)
